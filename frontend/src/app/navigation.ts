...
const monitoringStaff: Role[] = ['INSTITUTION_ADMIN', 'INVIGILATOR']
const resultStaff: Role[] = ['INSTITUTION_ADMIN', 'EXAMINER']
...
export const navigationItems: NavigationItem[] = [
  ...
  { label: 'Live monitoring', to: '/institution/monitoring', icon: MonitorCheck, roles: monitoringStaff },
  { label: 'Results', to: '/institution/results', icon: ScrollText, roles: resultStaff },
  ...
  { label: 'My results', to: '/student/results', icon: ScrollText, roles: ['STUDENT'] },
]
